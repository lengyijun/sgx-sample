...
bool save_signature(const char *const signature_file)
{
    ...
    ECDSA_SIG_set0(ecdsa_sig, bignum_from_little_endian_bytes_32((unsigned char *)signature_buffer),\
                        bignum_from_little_endian_bytes_32((unsigned char *)signature_buffer + 32));
